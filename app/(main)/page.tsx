...
import { ArrowRight, ShoppingBag, Sprout, Tag, Mail, Phone, MapPin, Leaf } from "lucide-react";

export default function Home() {
  return (
    <div className="py-8 lg:py-12 mx-2">
      {/* Bento Grid Container */}
      <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-7 gap-4 min-h-[1600px] md:h-[1800px] mt-12">
        ...
        <Card className="md:col-span-3 md:row-span-3 relative min-h-[400px] md:min-h-0 overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent flex flex-col justify-end p-8 text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 font-serif">Cultivez votre jardin intérieur</h1>
        ...
        <Card className="md:col-span-1 md:row-span-2 hover:bg-accent transition-colors cursor-pointer group flex flex-col justify-center">
          <CardHeader>
            <ShoppingBag className="text-primary mb-2 group-hover:scale-110 transition-transform" size={48} />
            <CardTitle className="text-3xl">Boutique</CardTitle>
            <CardDescription className="text-base">Lampes, tentes, extracteurs et tout le nécessaire pour l&apos;hydroponie.</CardDescription>
          </CardHeader>
        </Card>
        ...
        <Card className="md:col-span-1 md:row-span-1 bg-primary text-primary-foreground flex flex-col justify-center items-center text-center p-6 border-none">
          ...
          <CardDescription className="text-primary-foreground/80 text-xs">Avec le code <span className="font-bold">JARDIN20</span></CardDescription>
        </Card>
        ...
        <Card className="md:col-span-2 md:row-span-2 hover:bg-accent transition-colors cursor-pointer group flex flex-col justify-center p-8 bg-secondary/30 relative overflow-hidden">
           <Sprout className="text-primary/20 absolute -right-8 -bottom-8 group-hover:scale-110 transition-transform" size={240} />
           <div className="relative z-10">
             ...
             <CardDescription className="text-lg max-w-sm">
               Une sélection rigoureuse des meilleures variétés pour une croissance optimale et des récoltes généreuses.
             </CardDescription>
             <Button variant="outline" className="mt-6 gap-2">Découvrir la collection <ArrowRight size={16} /></Button>
           </div>
        </Card>
        ...
        <Card className="md:col-span-2 md:row-span-1 bg-accent/10 border-dashed flex items-center justify-center p-6 text-center italic text-muted-foreground">
          <p className="text-xl">&quot;Chaque graine est une promesse de vie et de beauté pour votre espace.&quot;</p>
        </Card>
        ...
        <Card className="md:col-span-1 md:row-span-1 bg-secondary/10 flex flex-col items-center justify-center p-6 text-center group hover:bg-secondary/20 transition-colors cursor-pointer">
           ...
           <CardTitle className="text-sm uppercase tracking-widest font-bold">Producteur 1</CardTitle>
           <CardDescription className="text-[10px]">Partenaire Premium</CardDescription>
        </Card>
        ...
        <Card className="md:col-span-1 md:row-span-1 bg-secondary/10 flex flex-col items-center justify-center p-6 text-center group hover:bg-secondary/20 transition-colors cursor-pointer">
           ...
           <CardTitle className="text-sm uppercase tracking-widest font-bold">Producteur 2</CardTitle>
